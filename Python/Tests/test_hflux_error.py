...
#Find the root directory dynamically. https://stackoverflow.com/questions/73230007/how-can-i-set-a-root-directory-dynamically
...
def test_check_matrix_type():
    ...
    dist_temp = np.array([[1, 2, 3]])
    time_temp = np.array([[1, 2, 3]])
    temp = np.matrix([[1, 2], [3, 4], [5, 6]])  # Not an array
